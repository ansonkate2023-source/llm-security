...
- **首個大規模 AI 自主間諜活動詳細揭露**：中國國家級威脅者使用 Claude Code 攻擊 30 組織，AI 執行 80-90%、每秒多次請求
- Jailbreak 技術：將攻擊拆為小型無害任務、偽稱資安公司員工，AI 自動偵察/滲透/萃取/建檔
- MLflow CVE-2025-15379（CVSS 10.0）命令注入 + PraisonAI CVE-2026-34938（CVSS 10.0）程式碼執行
- 本週全球新增 1,361 個 CVE（129 個嚴重），AI/ML 管道成為攻擊者積極目標
