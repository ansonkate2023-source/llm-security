...
- **BlueRock Security** 掃描 7,000+ MCP 伺服器，36.7% 存在 SSRF 漏洞
- **Adversa AI** 紅隊發現 Claude Code deny rules 在 50 個子命令後靜默失效（修復已在 Anthropic codebase 中）
- MCP 生態系統在 60 天內累積 30+ CVE，正從理論風險轉為實際攻擊面
- 來源：[Adversa AI](https://adversa.ai/blog/top-mcp-security-resources-april-2026/)

## 參考

- [MCP Security 2026: 30 CVEs in 60 Days](https://www.heyuan110.com/posts/ai/2026-03-10-mcp-security-2026/)
- [Adversa AI — Top MCP Security Resources](https://adversa.ai/blog/top-mcp-security-resources-april-2026/)
